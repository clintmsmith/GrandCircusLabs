document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkBoard() {
        for (let i = 0; i < winningArrays.length; i++) {
            ...
            // Check those squares to determine if they all have the class of 'player-one'
            ...
            // Check those squares to determine if they all have the class of 'player-two'
    ...
    for(let i = 0; i < squares.length; i++) {
        squares[i].onclick = () => {
            // If the square below your current square is 'taken', you can on top of it
